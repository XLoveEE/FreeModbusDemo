...
int main(void)
{
  ...
  while (1)
  {
  	printf("SR is %x\r\n",Read_W5500_SOCK_1Byte(0,Sn_SR));
		printf("Sn_Port is %x\r\n",Read_W5500_SOCK_2Byte(0,Sn_PORT));
		//printf("SIPR is %x\r\n",Read_W5500_1Byte(0x0012));
		printf("SIR is %x\r\n",Read_W5500_1Byte(SIR));
		printf("Sn_DIPR is %d.%d.%d.%d\r\n",Read_W5500_SOCK_1Byte(0,0x000c),Read_W5500_SOCK_1Byte(0,0x000D),
			Read_W5500_SOCK_1Byte(0,0x000E),Read_W5500_SOCK_1Byte(0,0x000F));
		eMBPoll(); 
  }
}
